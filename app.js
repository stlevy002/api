...
/* an interface between two applications allow
interactions between them without the use of less
abstract language
- two types of API's
    -browser API
    built into the browser and able to expose data
    from browser and environment, ex: DOM API
    allowing us to style page, make popup windows
    appear, etc.
    - third party API's
    require retrieval of their code from the web,
    such as GoogleMaps API
        -object based - have containers for the 
        data API uses
*/
// HTTP requests
/* defined set of request methods which indicate an
